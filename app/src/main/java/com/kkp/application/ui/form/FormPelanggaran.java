        ...
        btnKirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(et_judul.getText().toString().equals("")||
                    ...
                    builder = new AlertDialog.Builder(FormPelanggaran.this);
    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(FormPelanggaran.this,"Membuat Laporan","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                startActivity(new Intent(FormPelanggaran.this, TambahLaporanActivity.class));
            ...
            protected String doInBackground(Void... params) {
                ...
                FormPelanggaran.ImageProcessClass imageProcessClass = new FormPelanggaran.ImageProcessClass();
    ...
    public class ImageProcessClass{
        ...
        public String ImageHttpRequest(String requestURL,HashMap<String, String> PData) {
            ...
            try {
                ...
                httpURLConnectionObject.setRequestProperty("token", token);
